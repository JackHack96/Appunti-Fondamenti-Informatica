...
\begin{center}
    ...
    % |_a_
    \def\y{0.5*8}
    \draw ($(a1)$) -- ($(a1)+(0,\y)$) [dashed];
    \draw ($(a0)+(0,\y)$) -- ($(b0)+(0,\y)$) [dashed] node[midway,above]{a};
    % |_b_
    \draw ($(b1)$) -- ($(b1)+(0,\y)$) [dashed];
    \draw ($(b0)+(0,\y)$) -- ($(c0)+(0,\y)$) [dashed] node[midway,above]{b};
    % |_c
    \draw ($(c1)$) -- ($(c1)+(0,\y)$) [dashed];
    \draw ($(c0)+(0,\y)$) -- ($(d0)+(0,\y)$) [dashed] node[midway,above]{c};
    % |
    \draw ($(d1)$) -- ($(d1)+(0,\y)$) [dashed];
    
    % Possible divisions
    \def\y{0.5*7}
    \draw ($(b0)+(0,\y)$) -- ($(b0)+(0,\y)$) node[midway,above]{$v$};
    \draw ($(b0)+(2.5,\y)$) -- ($(b0)+(2.5,\y)$) node[midway,above]{$x$};
    
    \def\y{0.5*6}
    \draw ($(c0)+(-2.5,\y)$) -- ($(c0)+(-2.5,\y)$) node[midway,above]{$v$};
    \draw ($(c0)+(0,\y)$) -- ($(c0)+(0,\y)$) node[midway,above]{$x$};
    
    \def\y{0.5*5}
    \draw ($(a0)+(2.5,\y)$) -- ($(a0)+(2.5,\y)$) node[midway,above]{$vx$};
    
    \def\y{0.5*4}
    \draw ($(b0)+(2.5,\y)$) -- ($(b0)+(2.5,\y)$) node[midway,above]{$vx$};
    
    \def\y{0.5*3}
    \draw ($(c0)+(2.5,\y)$) -- ($(c0)+(2.5,\y)$) node[midway,above]{$vx$};
    
    \def\y{0.5*2}
    \draw ($(b0)+(-0.2,\y)$) -- ($(b0)+(-0.2,\y)$) node[midway,above]{$v$};
    \draw ($(b0)+(0.2,\y)$) -- ($(b0)+(0.2,\y)$) node[midway,above]{$x$};
        
    \def\y{0.5}
    \draw ($(c0)+(-0.2,\y)$) -- ($(c0)+(-0.2,\y)$) node[midway,above]{$v$};
    \draw ($(c0)+(0.2,\y)$) -- ($(c0)+(0.2,\y)$) node[midway,above]{$x$};
    \end{tikzpicture}
\end{center}
...
\begin{center}
	...
	% Original string rectangle
	\def\y{0.5*17}
	\draw ($(a)$) -- ($(a)+(0,\y+0.5)$) [dashed];
	\draw ($(a)+(0,\y)$) -- ($(b)+(0,\y)$) [dashed] node[midway,above]{$1\dots1$};
	
	\draw ($(b)$) -- ($(b)+(0,\y+0.5)$) [dashed];
	\draw ($(b)+(0,\y)$) -- ($(c)+(0,\y)$) [dashed] node[midway,above]{$00$};
	
	\draw ($(c)$) -- ($(c)+(0,\y+0.5)$) [dashed];
	\draw ($(c)+(0,\y)$) -- ($(d)+(0,\y)$) [dashed] node[midway,above]{$1\dots1$};
	
	\draw ($(d)$) -- ($(d)+(0,\y+0.5)$) [dashed];
	\draw ($(d)+(0,\y)$) -- ($(e)+(0,\y)$) [dashed] node[midway,above]{$00$};
	
	\draw ($(e)$) -- ($(e)+(0,\y+0.5)$) [dashed];
	\draw ($(e)+(0,\y)$) -- ($(f)+(0,\y)$) [dashed] node[midway,above]{$\dots$};
	
	% Possible divisions
	\def\y{0.5*16}
	\draw ($(a)+(2.5,\y)$) node[above]{$vx$};
	
	\def\y{0.5*15}
	\draw ($(b)+(-0.1,\y)$) node[above]{$v|x|$};
	
	\def\y{0.5*14}
	\draw ($(b)+(0,\y)$) node[above]{$vx$};
	
	\def\y{0.5*13}
	\draw ($(b)+(0.1,\y)$) node[above]{$|v|x$};
	
	\def\y{0.5*12}
	\draw ($(b)+(0.5,\y)$) node[above]{$vx$};
	
	\def\y{0.5*11}
	\draw ($(c)+(-0.1,\y)$) node[above]{$v|x|$};
	
	\def\y{0.5*10}
	\draw ($(c)+(0,\y)$) node[above]{$vx$};
	
	\def\y{0.5*9}
	\draw ($(c)+(0.1,\y)$) node[above]{$|v|x$};
	
	\def\y{0.5*8}
	\draw ($(c)+(2.5,\y)$) node[above]{$vx$};
	
	\def\y{0.5*7}
	\draw ($(d)+(-0.1,\y)$) node[above]{$v|x|$};
	
	\def\y{0.5*6}
	\draw ($(d)+(0,\y)$) node[above]{$vx$};
	
	\def\y{0.5*5}
	\draw ($(d)+(0.1,\y)$) node[above]{$|v|x$};
	
	\def\y{0.5*4}
	\draw ($(d)+(0.5,\y)$) node[above]{$vx$};
	
	\def\y{0.5*3}
	\draw ($(b)+(-0.2,\y)$) node[above]{$v$};
	\draw ($(c)+(0.2,\y)$) node[above]{$x$};
	
	\def\y{0.5*2}
	\draw ($(b)+(0,\y)$) node[above]{$|v|$};
	\draw ($(c)+(0.2,\y)$) node[above]{$x$};
	
	\def\y{0.5}
	\draw ($(b)+(-0.2,\y)$) node[above]{$v$};
	\draw ($(c)+(0,\y)$) node[above]{$|x|$};
...
\end{enumerate}
Se consideriamo $C_n$ con $n>2$, il linguaggio diventa non-CF, per cui dobbiamo dimostrarlo usando il pumping lemma.
\begin{itemize}
	\item $\forall z = uvwxy$
	\item $|z| \geq k$
	\item $|vwx| \leq k$
	...
	\item $uv^iwx^iy\in L$
\end{itemize}
Scegliamo una stringa, $z=(1^{2n}001^m)^n$, ed elenchiamo le possibili suddivisioni.
\begin{center}
	\begin{tikzpicture}
	% Defining main coordinates
	\coordinate (a) at (0,0);
	...
	% Bracket rectangle
	\def\y{0.5*18}
	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(a)+(0,\y)$.north east) -- ($(b)+(0,\y)$.north west) node [midway, above=0.2cm] {$2n$};
	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(b)+(0,\y)$.north east) -- ($(c)+(0,\y)$.north west) node [midway, above=0.2cm] {$2+m$};
	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(c)+(0,\y)$.north east) -- ($(d)+(0,\y)$.north west) node [midway, above=0.2cm] {$2n$};
	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(d)+(0,\y)$.north east) -- ($(e)+(0,\y)$.north west) node [midway, above=0.2cm] {$2+m$};
	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(e)+(0,\y)$.north east) -- ($(f)+(0,\y)$.north west) node [midway, above=0.2cm] {$|z|-2(2n+2+m)$};
	...
	\draw ($(b)$) -- ($(b)+(0,\y+0.5)$) [dashed];
	\draw ($(b)+(0,\y)$) -- ($(c)+(0,\y)$) [dashed] node[midway,above]{$0^21^m$};
	
	\draw ($(c)$) -- ($(c)+(0,\y+0.5)$) [dashed];
	\draw ($(c)+(0,\y)$) -- ($(d)+(0,\y)$) [dashed] node[midway,above]{$1\dots1$};
	
	\draw ($(d)$) -- ($(d)+(0,\y+0.5)$) [dashed];
	\draw ($(d)+(0,\y)$) -- ($(e)+(0,\y)$) [dashed] node[midway,above]{$0^21^m$};
...
Verifichiamo per ogni caso di violare le regole del pumping lemma, in modo da dimostrare che questo linguaggio non è CF.
\begin{itemize}
	\item $z=1^{2k-|vx|+|vx|\textbf{i}}0^21^m1^{2k}0^2$\\
	Affinché sia valida, deve valere $2k+|vx|(i-1)=2k$, quindi $|vx|(i-1)=0$, che però viola la condizione $|vx|>0$. \greenmark
