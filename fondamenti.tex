...
%	% Bracket rectangle
%	\def\y{0.5*18}
%	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(a)+(0,\y)$.north east) -- ($(b)+(0,\y)$.north west) node [midway, above=0.2cm] {$2n+2$};
%	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(b)+(0,\y)$.north east) -- ($(c)+(0,\y)$.north west) node [midway, above=0.2cm] {$m$};
%	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(c)+(0,\y)$.north east) -- ($(d)+(0,\y)$.north west) node [midway, above=0.2cm] {$2n+2$};
%	\draw [decorate, decoration={brace, amplitude=5pt, raise=2.5pt}] ($(d)+(0,\y)$.north east) -- ($(e)+(0,\y)$.north west) node [midway, above=0.2cm] {$m$};
...
%	\def\y{0.5*17}
%	\draw ($(a)$) -- ($(a)+(0,\y+0.5)$) [dashed];
%	\draw ($(a)+(0,\y)$) -- ($(b)+(0,\y)$) [dashed] node[midway,above]{$1\dots10^2$};
%	
%	\draw ($(b)+(0,\y)$) -- ($(c)+(0,\y)$) [dashed] node[midway,above]{$1^m$};
%	
%	\draw ($(c)$) -- ($(c)+(0,\y+0.5)$) [dashed];
%	\draw ($(c)+(0,\y)$) -- ($(d)+(0,\y)$) [dashed] node[midway,above]{$1\dots10^2$};
%	
%	\draw ($(d)+(0,\y)$) -- ($(e)+(0,\y)$) [dashed] node[midway,above]{$1^m$};
%	
%	\draw ($(e)$) -- ($(e)+(0,\y+0.5)$) [dashed];
%	\draw ($(e)+(0,\y)$) -- ($(f)+(0,\y)$) [dashed] node[midway,above]{$\dots$};
%	
...
%	
%	\def\y{0.5*11}
%	\draw ($(e)+(-0.1,\y)$) node[above]{$v|x|$};
%	
%	\def\y{0.5*10}
%	\draw ($(e)+(0,\y)$) node[above]{$vx$};
%	
%	\def\y{0.5*9}
%	\draw ($(e)+(0.1,\y)$) node[above]{$|v|x$};
%	
%	\def\y{0.5*8}
%	\draw ($(e)+(1,\y)$) node[above]{$vx$};
%	
%	\def\y{0.5*7}
%	\draw ($(d)+(-0.1,\y)$) node[above]{$v|x|$};
%	
